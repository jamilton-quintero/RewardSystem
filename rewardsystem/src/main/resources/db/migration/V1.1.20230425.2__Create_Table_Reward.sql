CREATE TABLE reward (
  ...
  reward_name TEXT NOT NULL COMMENT 'Name of reward for the company',
  multi_rewards BOOLEAN DEFAULT FALSE COMMENT 'Cumulative multi-reward system',
  daily_points_limit INT NULL COMMENT 'Maximum number of points that a user can accumulate in a day',
  weekly_points_limit INT NULL COMMENT 'Maximum number of points that a user can accumulate in a week',
